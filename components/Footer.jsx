...
const footerLinks = [
    ...
    },
    {
        ...
        links: [
            ...
            { label: "Backend & API", href: "/services#api-backend" },
            ...
            <div className={`container ${styles.footerContainer}`}>
                <div className={styles.footerTop}>
                    ...
                    <div className={styles.footerGroup}>
                        ...
                        <ul className={styles.groupLinks}>
                            <li>
                                <a href={`mailto:${company.contact.email}`} className={styles.footerLink}>
                                    {company.contact.email}
                                </a>
                            </li>
                            <li>
                                <a href={`tel:${company.contact.phone}`} className={styles.footerLink}>
                                    {company.contact.phone}
                                </a>
                            </li>
                            {company.contact.locations.map((loc) => (
                                <li key={loc}>
                                    <span className={styles.footerLink}>{loc}</span>
                                </li>
                            ))}
                        </ul>
                    </div>
